        ...
        <div class="container_4">
            ...
            <div class="grid_3" style="background: rgba(0,0,0,0.5); margin-left: 0px;">
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        <div class="tab1_item" style="font-family: 'Raleway', sans-serif; font-size: 20px;
                            color: White; text-decoration: none; height: 180px; background-color: transparent">
                            <a href='person_details.aspx?PID=<%# Eval("uid") %>'>
                                <img width="117" height="150" alt="" src='<%# Eval("user_filepath") %>' /></a>
