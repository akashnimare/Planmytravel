<%@ Page Language="C#" AutoEventWireup="true" CodeFile="all_story.aspx.cs" Inherits="all_story" %>
...
<head runat="server">
    ...
    <style type="text/css" media="all">
        body
        {
            padding: 0;
            margin: 0;
            background-image: url('mimgs/Taj_Mahal_Mosque_Interior_Hall.jpg');
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    ...
                    <ItemTemplate>
                        ...
                        <div class="grid_4" style="padding-left: 2px; margin-left: 10px;">
                            <a class="prdocutname" href='packege_details.aspx?PID=<%# Eval("UEID") %>' style="font-family: 'Raleway', sans-serif;
